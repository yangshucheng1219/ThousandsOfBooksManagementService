...
import com.wanjuanshu.o2o.dao.PersonInfoDao;
import com.wanjuanshu.o2o.dto.ShopAuthMapExecution;
import com.wanjuanshu.o2o.dto.UserAccessToken;
import com.wanjuanshu.o2o.dto.UserAwardMapExecution;
import com.wanjuanshu.o2o.dto.WechatInfo;
import com.wanjuanshu.o2o.entity.*;
import com.wanjuanshu.o2o.enums.UserAwardMapStateEnum;
import com.wanjuanshu.o2o.service.PersonInfoService;
import com.wanjuanshu.o2o.service.ShopAuthMapService;
import com.wanjuanshu.o2o.service.UserAwardMapService;
import com.wanjuanshu.o2o.service.WechatAuthService;
import com.wanjuanshu.o2o.util.HttpServletRequestUtil;
import com.wanjuanshu.o2o.util.wechat.WechatUtil;
...
public class UserAwardManagementController {
    ...
    private String exchangeAward(HttpServletRequest request, HttpServletResponse response) throws IOException {
        Long userAwardId = Long.valueOf(request.getParameter("AwardId"));
