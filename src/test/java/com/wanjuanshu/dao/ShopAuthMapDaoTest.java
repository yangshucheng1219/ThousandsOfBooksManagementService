...
public class ShopAuthMapDaoTest {
	...
	public void testBQueryShopAuth() throws Exception {
		...
		List<ShopAuthMap> shopAuthMapList = shopAuthMapDao.queryShopAuthMapListByShopId(20, 0, 2);
		...
		int count = shopAuthMapDao.queryShopAuthCountByShopId(20);
	...
	public void testCUpdateShopAuthMap() throws Exception {
		List<ShopAuthMap> shopAuthMapList = shopAuthMapDao.queryShopAuthMapListByShopId(20, 0, 1);
	...
	public void testDeleteShopAuthMap() throws Exception {
		List<ShopAuthMap> shopAuthMapList1 = shopAuthMapDao.queryShopAuthMapListByShopId(20, 0, 1);
		List<ShopAuthMap> shopAuthMapList2 = shopAuthMapDao.queryShopAuthMapListByShopId(27, 0, 1);
